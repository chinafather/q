...
$(document).ready(function(){
	...
	$(function () {
	    ...
	    var menu = [
                {
                    "title": "Dashboard", "url": "index.html", "icss": "icon-bar-chart", "bcontainer": "false"
                },
                {
                    "title": "Messages", "url": "messages.html", "icss": "icon-envelope", "bcontainer": "false"
                },
                {
                    "title": "Tasks", "url": "tasks.html", "icss": "icon-tasks", "bcontainer": "false"
                },
                {
                    "title": " UI Features", "url": "ui.html", "icss": "icon-eye-open", "bcontainer": "false"
                },
                {
                    "title": "Widgets", "url": "widgets.html", "icss": "icon-dashboard", "bcontainer": "false"
                },
                {
                    "title": "Dropdown", "url": "##l", "icss": "icon-folder-close-alt", "bcontainer": "true", "submenulist": [{
                        "title": "Sub Menu 1", "url": "submenu.html", "icss": "icon-file-alt", "bcontainer": "false"
                    }, {
                        "title": "Sub Menu 2", "url": "submenu2.html", "icss": "icon-file-alt", "bcontainer": "false"
                    }, {
                        "title": "Sub Menu 3", "url": "submenu3.html", "icss": "icon-file-alt", "bcontainer": "false"
                    }]
                },
                {
                    "title": "Forms", "url": "form.html", "icss": "icon-edit", "bcontainer": "false"
                },
                {
                    "title": "Charts", "url": "chart.html", "icss": "icon-list-alt", "bcontainer": "false"
                },
                {
                    "title": "Typography", "url": "typography.html", "icss": "icon-font", "bcontainer": "false"
                },
                {
                    "title": "Gallery", "url": "gallery.html", "icss": "icon-picture", "bcontainer": "false"
                },
                {
                    "title": "Tables", "url": "table.html", "icss": "icon-align-justify", "bcontainer": "false"
                },
                {
                    "title": "Calendar", "url": "calendar.html", "icss": "icon-calendar", "bcontainer": "false"
                },
                {
                    "title": "File Manager", "url": "file-manager.html", "icss": "icon-folder-open", "bcontainer": "false"
                },
                {
                    "title": "Icons", "url": "icon.html", "icss": "icon-star", "bcontainer": "false"
                },
                {
                    "title": "Login Page", "url": "login.html", "icss": "icon-lock", "bcontainer": "false"
                }
	    ...
	    $.each(menu, function (key, value) {
	        if (value.bcontainer != "true") {
	            menuhtml += ' <li><a href="' + value.url + '"><i class="' + value.icss + '"></i><span class="hidden-tablet"> ' + value.title + '</span></a></li>';
	        }
	        else {

	            menuhtml += ' <li><a href="' + value.url + '" class="dropmenu"><i class="' + value.icss + '"></i><span class="hidden-tablet"> ' + value.title + '</span><span class="label label-important">' + value.submenulist.length + '</span></a>';
	            menuhtml += "<ul>";
	            $.each(value.submenulist, function (k, v) {
	                menuhtml += '<li><a class="submenu" href="' + v.url + '"><i class="' + v.icss + '"></i><span class="hidden-tablet"> ' + v.title + '</span></a></li>';
	            });
	            menuhtml += "</ul></li>";
	        }
	    });
