...
namespace Cares.FidsII.Util
{
    ...
    {
        private static string _ConnectionStringLocalTransaction = "";

        public static string ConnectionStringLocalTransaction
        {
            get { return OracleHelper._ConnectionStringLocalTransaction; }
            set { OracleHelper._ConnectionStringLocalTransaction = value; }
        }
